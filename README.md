...
**This project was entirely built using AI tools** — specifically through conversations with the Hermes Agent (by Nous Research) running various models via OpenCode Zen's free tier and Claude Sonnet 4.
